<div class="navbar col-12">
            ...
            <li class="nav-item menu-item1"><a class="nav-link" href="">About</a></li>
                <li class="nav-item menu-item2"><a class="nav-link" href="">Kosovo Wall</a></li>
                <li class="nav-item menu-item3"><a class="nav-link" href="">Future Vote</a></li>
                <li class="nav-item menu-item4"><a class="nav-link" href="">Child’s dream</a></li>
                ...
                <li class="nav-item menu-item5"><a class="nav-link" href="">Im Kosover</a></li>
                <li class="nav-item menu-item6"><a class="nav-link" href="">Travel VR</a></li>
                <li class="nav-item menu-item7"><a class="nav-link" href="">Partners</a></li>
                <li class="space"></li>
