<session class="sessions s2 row stickySection activeSection">
                ...
                <div class="col-12 col-xl-6">
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="img/carousel-img-1.JPG" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="img/carousel-img-2.JPG" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="img/carousel-img-3.JPG" alt="Third slide">
                                </div>
                                </div>
                ...
                <div class="col-12 col-xl-6">
                    <p>Organized by Taiwan and Kosovo Cultural Exchange Association, Kosovo NEXT10 is an exhibition aims to visualize Kosovo’s vision in the next 10 years . Through the interactive artworks, the exhibition guides visitors exploring Kosovo’s different aspects, and contributing their ideas for Kosovo’s future in the collective creation to share it with others. </p>
